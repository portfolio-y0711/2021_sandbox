...
const CCH_DB_SEED = new AsyncActionCommand(SENDER_TYPE.CACHE, SUBJECT_TYPE.DB, COMMAND_TYPE.SEED);
const CCH_DB_SYNC = new ActionCommand(SENDER_TYPE.CACHE, SUBJECT_TYPE.DB, COMMAND_TYPE.SYNC);
const CCH_DB_FETCH = new AsyncActionCommand(SENDER_TYPE.CACHE, SUBJECT_TYPE.DB, COMMAND_TYPE.FETCH);
const CCH_DB_CREATE = new AsyncActionCommand(SENDER_TYPE.CACHE, SUBJECT_TYPE.DB, COMMAND_TYPE.CREATE);
const CCH_DB_DELETE = new AsyncActionCommand(SENDER_TYPE.CACHE, SUBJECT_TYPE.DB, COMMAND_TYPE.DELETE);
