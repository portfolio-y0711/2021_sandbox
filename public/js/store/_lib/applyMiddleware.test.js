const LOG = (msg) => { process.env.DEBUG ? console.log(msg): null }
...
describe('Store Module: applyMiddleware', () => {
    ...
    it('async middleware handle action with promised payload', async() => {
        ...
        store.dispatch({ type: 'async request', payload: new Promise(resolve => { resolve(expected)})})
